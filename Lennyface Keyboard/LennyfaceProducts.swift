...
public struct LennyfaceProducts
{

	// TODO:  Change this to the BundleID chosen when registering this app's App ID in the Apple Member Center.
	private static let Prefix = "com.roymunsonstudios.LennyfaceKeyboard."

	public static let FullVersion = Prefix + "FullVersionKeyboard"

	private static let productIdentifiers: Set<ProductIdentifier> = [LennyfaceProducts.FullVersion]
	 ...
	 */
	public static let store = IAPHelper(productIds: LennyfaceProducts.productIdentifiers)
}
