...
//	private var deleteCounter: Int = 0
	...
	private let tabTitles: [String] = ["Lenny", "Animal", "Table Flip", "Magic", "Donger", "Glasses", "Misc."]

	private let mainButtonTitles: [[String]] = [
		["( ͡° ͜ʖ ͡°)", "( ͡☉ ͜ʖ ͡☉)", "( ͡° ʖ̯ ͡°)",
			"(つ ͡° ͜ʖ ͡°)つ", "ᕦ( ͡° ͜ʖ ͡°)ᕤ", "ᕙ( ͡° ͜ʖ ͡°)ᕗ",
			"ᕕ( ͡° ͜ʖ ͡°)ᕗ", "ヽ( ͝° ͜ʖ͡°)ﾉ", "ヽ(͡◕ ͜ʖ ͡◕)ﾉ"],

		["ʕ ᓀ ᴥ ᓂ ʔ", "୧ʕ•̀ᴥ•́ʔ୨", "ʕ⊙ᴥ⊙ʔ",
			"(^ ◕ᴥ◕ ^)", "(V●ᴥ●V)", "(⊃･ᴥ･)つ",
			"ʕ ☉ (oo) ☉ ʔ", "▐ ᓀ (oo) ᓂ ▐", "໒( ⊚ (oo) ⊚ )७"],

		["_|___|_  ╰(º o º╰)", "(ﾉಠдಠ)ﾉ︵┻━┻", "(╯=▃=)╯︵┻━┻",
			"┻━┻ ヘ╰( •̀ε•́ ╰)", "༼ﾉຈل͜ຈ༽ﾉ︵┻━┻", "(╯ ͝° ͜ʖ͡°)╯︵ ┻━┻",
			"┬───┬ ノ༼ຈل͜ຈノ༽", "┏━┓ ︵ /(^.^/)", "┬─┬ノ( ◕◡◕ ノ)"],

		["╰( ⁰ ਊ ⁰ )━☆ﾟ.*･｡ﾟ", "(つ◕౪◕)つ━☆ﾟ.*･｡ﾟ", "╰(•̀ 3 •́)━☆ﾟ.*･｡ﾟ",
			"ヽ༼ຈل͜ຈ༽⊃─☆*:・ﾟ", "ᕦ( ~ ◔ ᴥ ◔ ~ )੭━☆ﾟ.*･｡ﾟ", "(∩｀-´)⊃━☆ﾟ.*･｡ﾟ",
			"╰( ͡° ͜ʖ ͡° )つ──☆*:・ﾟ", "༼∩☉ل͜☉༽⊃━☆ﾟ. * ･ ｡ﾟ", "༼∩✿ل͜✿༽⊃━☆ﾟ. * ･ ｡ﾟ"],

		["༼ ºل͟º༽", "ᕦ༼ ✖ ਊ ✖ ༽ᕤ", "┌༼◉ل͟◉༽┐",
			"Ѱζ༼ᴼل͜ᴼ༽ᶘѰ  ", "ᕙ༼ຈل͜ຈ༽ᕗ ", "ᕕ༼ ͠ຈ Ĺ̯ ͠ຈ ༽┌∩┐",
			" ζ༼Ɵ͆ل͜Ɵ͆༽ᶘ ", "୧༼ಠ益ಠ༽୨", "o͡͡͡╮༼ ʘ̆ ۝ ʘ̆ ༽╭o͡͡͡"],
	...
	override func viewDidLoad()
	{
		...
		let IAPFetch = Keychain(service: "com.roymunsonstudios.LennyfaceKeyboard")

		var purchased = false
		do
		{
			let purchaseStatusData = try IAPFetch.getData(LennyfaceProducts.FullVersion)
			...
			} else
			{
				...
				try! IAPFetch.set(purchaseData, key: LennyfaceProducts.FullVersion)
			}
		...
		} else
		{
			...
			purchaseReminder!.text = "To access all the buttons in the keyboard buy the upgrade."
	...
	func rowButtonPressed(sender: UIButton!)
	{
		...
		let outputString = mainButtonTitles[keyboardState][sender.tag]
